...
var gifcount=0;
var greeting=0;
var x=new Audio("/beats/beat"+1+".mp3");
var a=0;
var temp=0;
let mixer_visi=0;
let scenes_visi=0;
...
function changebeatback(){
    ...
    x.pause()
    x=new Audio("/beats/beat"+num+".mp3");
    if(document.querySelector(".k").getAttribute("src")!="https://app.lofi.co/icons/new/play.svg") x.play()
}
...
if(a%2==0)isplaying=true
    if(isplaying==false){
        console.log("ddddd")
        document.querySelector(".playbtn").innerHTML="<img class='k pause' src='https://app.lofi.co/icons/new/pause.svg' >"
        if(isMobileDevice)document.querySelector(".k").style.width="8px"
      x.play();
...
function audiopause(){
    ...
    document.querySelector(".playbtn").innerHTML="<img class='k play' src='https://app.lofi.co/icons/new/play.svg' >"
    if(isMobileDevice)document.querySelector(".k").style.width="8px"
